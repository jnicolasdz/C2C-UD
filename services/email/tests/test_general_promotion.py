...
def test_general_promotion_sends_campaign(monkeypatch) -> None:
    ...
    response = client.post(
        "/api/v1/emails/promotions/general",
        ...
        json={
            ...
            "id_prom": 2026,
            "tipo_prom": "Descuento especial",
            "descripcion_prom": "Disfruta de un 30% de descuento en la próxima compra.",
            "fecha_fin_prom": "2026-06-30",
        },
    )
    ...
    assert body["message"] == "Campaña procesada."
